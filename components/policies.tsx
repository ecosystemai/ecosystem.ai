...
const PrivacyPolicy = () => {
  return (
    <main className="max-w-xl mx-auto">
      <div className="p-5">
        <h1 className="text-3xl font-extrabold pb-6">Privacy Policy for ecosystem.Ai</h1>

        <pre className="leading-relaxed whitespace-pre-wrap" style={{ fontFamily: 'sans-serif' }}>
          {`Effective Date: February 18, 2024

This Privacy Policy outlines the types of personal information that is received and collected by ecosystem.Ai`}{' '}
          <Link href="https://ecosystem.ai">https://ecosystem.ai</Link>
          {` and how it is used.
...
ecosystem.Ai is committed to protecting the privacy of children. We do not knowingly collect any personal information from children under the age of 13.
...
If you have any questions about this Privacy Policy, please contact us at`}{' '}
          <Link href="mailto:amy@ecosystem.ai">amy@ecosystem.ai</Link>
          {`. 

Your use of ecosystem.Ai indicates your agreement to this Privacy Policy.`}
        </pre>
      </div>
...
const TermsOfServices = () => {
  return (
    <main className="max-w-xl mx-auto">
      <div className="p-5">
        <h1 className="text-3xl font-extrabold pb-6">Terms and Conditions for ecosystem.Ai</h1>

        <pre className="leading-relaxed whitespace-pre-wrap" style={{ fontFamily: 'sans-serif' }}>
          {`Effective Date: February 18, 2024

Welcome to ecosystem.Ai, the informational website for the behavioral prediction platform, available at `}{' '}
          <Link href="https://ecosystem.ai">https://ecosystem.ai</Link>
          ...
          <Link href="https://ecosystem.ai/privacy">https://ecosystem.ai//privacy</Link>
          {`.

1. Ownership
Upon purchasing a package from ecosystem.Ai, you are granted the right to download and use the code for accessing an admin panel for ecosystem.Ai. While you own the downloaded code, you are expressly prohibited from reselling, redistributing, or otherwise transferring the code to third parties without explicit permission from ecosystem.Ai.
...
const CookiePolicy = () => {
  return (
    <main className="max-w-xl mx-auto">
      <div className="p-5">
        <h1 className="text-3xl font-extrabold pb-6">Cookie Policy for ecosystem.Ai</h1>
